...
async function createJob(req, res, next) {
  try {
    const { company, position, dateApplied, status, link, reference, notes, stages } = req.body;
...
async function updateJob(req, res, next) {
  try {
    const { _id, company, position, dateApplied, status, link, reference, notes, stages } = req.body;
